...
<div id="dlgUser"style="font-size:9pt;" title="User">
    <form id="frmUser" class="form-horizontal" role="form" method="POST" action="/frm/admin/all/customercares">
        <input type="hidden" class="form-control" id="action" name="action" />
        <input type="hidden" class="form-control" id="uId" name="userId" />
        <input type="hidden" class="form-control" id="uRole" name="userRole" value="admin_customer" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                ...
                <input type="number" class="form-control input-sm" id="phone" name="userPhone[]" placeholder="Phone" required>
            </div>
...
<!--                <button id="btnAddPhone" type="button" class="btn btn-default btn-xs">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control input-sm" id="dob" name="userBirthDate" placeholder="Date of Birth (yyyy-mm-dd)" required>
            </div>
        </div>
        <div class="form-group">
...
@section('admin_content')
            <h2 class="sub-header">Customer Care</h2>
...
$().ready(function() {
    ...
    $("#grid").bootgrid({
        ajax: true,
        url: "/api/admin/users?role=admin_customer",
        ajaxSettings: {
            method: "GET",
            cache: false
        },
