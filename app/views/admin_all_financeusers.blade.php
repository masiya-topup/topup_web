...
<div id="dlgUser"style="font-size:9pt;" title="User">
    <form id="frmUser" class="form-horizontal" role="form" method="POST" action="/frm/admin/all/financeusers">
        <input type="hidden" class="form-control" id="action" name="action" />
        <input type="hidden" class="form-control" id="uId" name="userId" />
        <input type="hidden" class="form-control" id="uRole" name="userRole" value="admin_finance" />
...
<!--                <button id="btnAddPhone" type="button" class="btn btn-default btn-xs">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="date" class="form-control input-sm" id="dob" name="userBirthDate" placeholder="Date of Birth" required>
            </div>
        </div>
        <div class="form-group">
...
@section('admin_content')
            <h2 class="sub-header">Finance Users</h2>
...
$().ready(function() {
    ...
    $("#grid").bootgrid({
        ajax: true,
        url: "/api/admin/users?role=admin_finance",
        ajaxSettings: {
            method: "GET",
            cache: false
        },
